	...
	<div id="menu-wrapper">
		<div id="menu">
			<ul>
				...
				<li><a href="adminprojectassociation.php">Project association to program</a></li>
			</ul>     
	</div>
	</div>
	<!-- end #menu -->
					...
					<div id="content">
						<div class="post">
                                ...
                                <h2>Fill in to view:</h2>
								    <form method="post" action="adminviewproject.php">
								        <table border="0">
								            <tr>
								                <td height="30" style="font-size: 20px;">Choose your option to search</td>
								                <td><select name="choice1" required>
								                        <option value=" ">Select anyone</option>
								                        <option value="PRJ_ID">Project Id</option>
                                                        <option value="PRJ_NAME">Project name</option>
                                                        <option value="PRJ_DURATION">Project Duration</option>
                                                        <option value="PRJ_LOCATION">Project Location</option>
                                                        <option value="PRJ_I_ID">Project Guide Id</option>
								                    </select></td>
								            </tr>
								             <tr>
