			...
			<div id="page-bgbtm">
				<div id="page-content">
					<div id="content">
						<div class="post">
								<center>
                                <h2>Fill the details of the project to be added</h2>
								    <form method="post" action="">
								        <table border="0">
								            <tr>
								                <td height="30" style="font-size: 20px;">Project Id: </td>
								                <td><input type="text" name="PRJ_ID" required="required" /></td>
								            </tr>
								            <tr>
								                <td height="30" style="font-size: 20px;">Project Name: </td>
								                <td><input type="text" name="PRJ_NAME" required="required" /></td>
								            </tr>
								            <tr>
								                <td height="30" style="font-size: 20px;">Project Duration: </td>
								                <td><input type="text" name="PRJ_DURATION" required="required"/></td>
								            </tr>
								            <tr>
								                <td height="30" style="font-size: 20px;">Project Location: </td>
								                <td><input type="text" name="PRJ_LOCATION" required="required"/></td>
								            </tr>
								            <tr>
								                <td height="30" style="font-size: 20px;">Project Guide Id: </td>
								                <td><input type="text" name="PRJ_I_ID" required="required"/></td>
								            </tr>
								            <tr>
								                <td height="30" style="font-size: 20px;">Project Year: </td>
								                <td><input type="text" name="PRJ_YEAR" required="required"/></td>
								            </tr>
								            <tr>
								                <td>
								                    <center>
...
$PRJ_YEAR=$_POST['PRJ_YEAR'];
	...
	if (mysqli_num_rows($rn)>0) {
		echo '<script type="text/javascript">alert("Error ! Project id already exists.....!!!! ");   window.location="adminaddproject.php";</script>';
	}else{
    
$sql1="INSERT into project values('$PRJ_ID','$PRJ_NAME','$PRJ_DURATION','$PRJ_LOCATION','$PRJ_I_ID','$PRJ_YEAR')";
