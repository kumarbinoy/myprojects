		...
		<div id="menu">
			<ul>
				<li class="current_page_item"><a href="adminhome.php">Home</a></li>
                 <li><a href="adminaddinstructor.php">Add Instructor</a></li>
			</ul>     
	</div>
	</div>
	<!-- end #menu -->
					...
					<div id="content">
						<div class="post">
                                ...
                                <h2>Fill in to view</h2>
								    <form method="post" action="adminviewinstructor.php">
								        <table border="0">
								            <tr>
								                <td height="30" style="font-size: 20px;">Choose your option to search</td>
								                <td><select name="choice1" required>
								                        <option value=" ">Select anyone</option>
								                        <option value="I_ID">Instructor Id</option>
                                                        <option value="I_F_NAME">First name</option>
                                                        <option value="I_L_NAME">Last Name</option>
                                                        <option value="I_EMAIL">Email</option>
                                                        <option value="I_D_ID">Instructor department Id</option>
								                    </select></td>
								            </tr>
								             <tr>
