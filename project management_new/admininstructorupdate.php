					...
					<div id="content">
						<div class="post">
                                ...
                                <h2>Fill the details</h2>
								    <form method="post" action="admininstructorupdate.php">
								        <table border="0">
								            <tr>
								                <td height="30" style="font-size: 20px;">Instructor Id: </td>
								                <td><input type="text" name="I_ID" value="<?php echo $rows['I_ID']; ?>"required="required" /></td>
								            </tr>
								            <tr>
								                <td height="30" style="font-size: 20px;">First Name: </td>
								                <td><input type="text" name="I_F_NAME" required="required" value="<?php echo $rows['I_F_NAME']; ?>" /></td>
								            </tr>
								            <tr>
								                <td height="30" style="font-size: 20px;">Last Name: </td>
								                <td><input type="text" name="I_L_NAME" required="required" value="<?php echo $rows['I_L_NAME']; ?>"/></td>
								            </tr>
								            <tr>
								                <td height="30" style="font-size: 20px;">Instructor Email: </td>
								                <td><input type="email" name="I_EMAIL" required="required" value="<?php echo $rows['I_EMAIL']; ?>"/></td>
								            </tr>
								            <tr>
								                <td height="30" style="font-size: 20px;">Instructor department Id: </td>
								                <td><input type="text" name="I_D_ID" required="required" value="<?php echo $rows['I_D_ID']; ?>"/></td>
								            </tr>
								            <tr>
								                <td>
								                    <center>
...
$sql = "UPDATE instructor SET I_ID='$I_ID', I_F_NAME='$I_F_NAME',I_L_NAME='$I_L_NAME',I_EMAIL='$I_EMAIL', I_D_ID='$I_D_ID' WHERE I_ID='$I_ID'";
