...
$sql1="select * from project_request where STU_ROLL='".$_SESSION['ROLL_NO']."'";
$result1=mysqli_query($conn,$sql1);

$sql4="SELECT * from allocation where A_ROLL_NO='".$_SESSION['ROLL_NO']."'";
$result4=mysqli_query($conn,$sql4);
    if((mysqli_num_rows($result1)>0) &&(mysqli_num_rows($result4)>0)){ 
?>
<html>
<head>
		...
		?>
                    ...
                    <div id="sidebar">
						<ul>
							<li>
							<center>
								<h3><b>Enter your choice in serial order to update</b></h3><br>
								    <form method="post" action="studentprojectupdate1.php">
								        <table border="0">
                                      <tr>
